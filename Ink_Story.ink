...
Little nautical knick knacks lines the shelfs, held down by some sort of adheasive puddy to keep them from falling off while the ship is in motion. The bunk bed and extra sleeping bag both lay empty with messy sheets. Seems like the other two have already gotten up.
    ...
    * [Continue] -> Day_2_Buoy
    ...
    = Day_2_Buoy
        ...
        = Island
            Light rain forms droplets on the windshield as the boat pushes on. Despite how fun piloting the boat is, you have to admit that at the speed you're going, it lost it's charm and became mind-numbing real quick.
            ...
            It almost seems like the boat is moving a lot slower than normal. Maybe {adam_state > 0: Adams concerns | your concerns} were right earlier about the engine. 
            ...
            You look down at the GPS. Not too long now.
            ...
            You seem to be forgetting something. Or multiple somethings. Though it pains you to try thinking about that.
            ...
            {
                - carl_state > 0 || adam_state > 0: 
                    You rented this boat, right? Probably should make sure it's clean when you get back. The train of thought is halted though, as the pain seeps back into your mind, twice as strong. It lingers just long enough for you to loose track of your thoughts, before leaving you just as fast as it had came.
                        ...
            }
            You can see what resembles a patch of sand and reeds about the size of the boat itself. Looks like you're here. 
            * [Continue] -> island_2
            = island_2
